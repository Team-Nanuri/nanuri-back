...
public class UpdateArticleCommand extends SelfValidating<UpdateArticleCommand> {
    ...
    public UpdateArticleCommand(Long articleId, Long userId, ItemCategory category, ShareType shareType, LocalDate rentalStartDate, LocalDate rentalEndDate, String title, String content, List<MultipartFile> images) {
